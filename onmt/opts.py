...
def multi_preprocess_opts(parser):
    """ Pre-procesing options """
    # Data options
    group = parser.add_argument_group('Data')
    group.add('--data_type', '-data_type', default="text",
    ...
    group.add('--langs', '-langs', default="",
              help="Translation languages, like `en,fr,zh`.")

    group.add('--train_src', '-train_src', required=True,
              help="Path to the training source data: en-fr:./data/src-train.txt")
    group.add('--train_tgt', '-train_tgt', required=True,
              help="Path to the training target data")
    group.add('--valid_src', '-valid_src',
              help="Path to the validation source data")
    ...
    # Truncation options, for text corpus
    group = parser.add_argument_group('Pruning')
    group.add('--multi_seq_length', '-multi_seq_length', type=int, default=50,
              help="Maximum multi sequence length")
    group.add('--multi_seq_length_trunc', '-multi_seq_length_trunc',
              type=int, default=None,
              help="Truncate multi sequence length.")
    group.add('--src_seq_length', '-src_seq_length', type=int, default=50,
              help="Maximum source sequence length")
    group.add('--src_seq_length_trunc', '-src_seq_length_trunc',
              type=int, default=None,
